...
- `notebooks/` – экспериментальные ноутбуки:
  - `polonik_eda_churn.ipynb` — разведочный анализ данных, первичная подготовка признаков и визуализация.
- `src/` – основной код проекта:
  - `__init__.py` — содержит модули для обучения моделей, выполнения предсказаний, запуска API-сервиса, работы с конфигурациями и логированием.;
...
- `Dockerfile` — инструкции для сборки Docker-образа и контейнерного запуска проекта.
- `.gitignore` — список файлов и папок, которые не должны попадать в репозиторий, например виртуальное окружение, кэш Python и локальные артефакты.
