...
- `docker/` - файлы для контейнеризации
  ...
  - `docker-compose.yml`- оркестрация контейнеров для упрощённого запуска
...
Источник: [[https://www.kaggle.com/datasets/aakash50897/churn-modellingcsv](https://www.kaggle.com/datasets/uttam94/churn-modellingcsv)](https://www.kaggle.com/datasets/uttam94/churn-modellingcsv)
...
5. Покажу ноутбук 04_catboost_models.ipynb с результатами экспериментов, а также сравнение baseline-модели и финальной модели CatBoost по метрикам.
